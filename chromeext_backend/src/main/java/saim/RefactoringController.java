...
public class RefactoringController {
    ...
    public String returnrefs(String url, String id, String uuid) {
        ...
        if (refactoringMessages.toString().trim().isEmpty()) {
            return llm.generateSummaryForNoRefactorings(fullUrl, service, aiToken);
        } else {
            return llm.generateSummaryForRefactorings(refactoringMessages.toString(), refactoringInstances, aiToken);
        }
    }
